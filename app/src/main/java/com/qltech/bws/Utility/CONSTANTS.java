...
public class CONSTANTS {
    ...
    public interface ACTION {
        public static String MAIN_ACTION = "com.qltech.bws.action.main";
        public static String INIT_ACTION = "com.qltech.bws.action.init";
        public static String PREV_ACTION = "com.qltech.bws.action.prev";
        public static String PLAY_ACTION = "com.qltech.bws.action.play";
        public static String NEXT_ACTION = "com.qltech.bws.action.next";
        public static String STARTFOREGROUND_ACTION = "com.qltech.bws.action.startforeground";
        public static String STOPFOREGROUND_ACTION = "com.qltech.bws.action.stopforeground";
    }
