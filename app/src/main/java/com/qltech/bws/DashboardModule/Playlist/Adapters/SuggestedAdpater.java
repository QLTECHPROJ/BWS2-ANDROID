...
public class SuggestedAdpater extends RecyclerView.Adapter<SuggestedAdpater.MyViewHolder> {
    private List<SuggestedModel> listModelList;
    Context ctx;

    public SuggestedAdpater(List<SuggestedModel> listModelList, Context ctx) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        SuggestedModel listModel = listModelList.get(position);
