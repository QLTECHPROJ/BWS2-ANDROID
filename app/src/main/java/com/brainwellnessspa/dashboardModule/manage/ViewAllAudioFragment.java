      ...
      try {
        ...
        if (Name.equalsIgnoreCase("My Downloads")) {
          if (AudioPlayerFlag.equalsIgnoreCase("DownloadListAudio")) {
            ...
            ArrayList<ViewAllAudioListModel.ResponseData.Detail> listModelList2 =
                new ArrayList<>(listModelList);
            Gson gson = new Gson();
            ...
            Type type = new TypeToken<HomeScreenModel.ResponseData.DisclaimerAudio>() {}.getType();
