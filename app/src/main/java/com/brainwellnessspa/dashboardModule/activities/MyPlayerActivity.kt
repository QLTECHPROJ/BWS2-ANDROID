...
//            callllInfoViewQClicks()
    ...
    fun GetMedia2() {
        DB = getAudioDataBase(ctx)
        try {
            DB!!.taskDao().getaudioByPlaylist1(mainPlayModelList[position].audioFile, "", CoUserID).observe(
                    this,
                    { audiolist: List<DownloadAudioDetails> ->
                        if (audiolist.isNotEmpty()) {
                            ...
                            DB!!.taskDao()
                                    .getaudioByPlaylist1(mainPlayModelList[position].audioFile, "", CoUserID)
        ...
        GetMediaPer();
        disableDownload();
    }*/DB!!.taskDao().getaudioByPlaylist1(mainPlayModelList[position].audioFile, "", CoUserID)
                                    .removeObserver { }
                        }
                    })
        } catch (e: java.lang.Exception) {
