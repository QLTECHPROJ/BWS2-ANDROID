...
import com.brainwellnessspa.databinding.ActivityEepProfileStepOneBinding
...
class EEPProfileStepOneActivity : AppCompatActivity() {
    lateinit var binding: ActivityEepProfileStepOneBinding
    ...
    private var userTextWatcher: TextWatcher = object : TextWatcher {
        ...
        override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
            ...
            if (binding.llAddress.visibility == View.VISIBLE || binding.llAddress.visibility == View.VISIBLE) {
            ...
            if (binding.llFifth.visibility == View.VISIBLE  || binding.llFifth.visibility == View.VISIBLE) {
            ...
            if (binding.llSixth.visibility == View.VISIBLE  || binding.llSixth.visibility == View.VISIBLE) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_eep_profile_step_one)
        ctx = this@EEPProfileStepOneActivity
        act = this@EEPProfileStepOneActivity
