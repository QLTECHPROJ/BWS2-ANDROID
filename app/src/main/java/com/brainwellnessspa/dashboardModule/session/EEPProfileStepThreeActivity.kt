...
import com.brainwellnessspa.databinding.ActivityEepProfileStepThreeBinding
...
class EEPProfileStepThreeActivity : AppCompatActivity() {
    lateinit var binding: ActivityEepProfileStepThreeBinding
    ...
    private var userTextWatcher: TextWatcher = object : TextWatcher {
        ...
        override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
            ...
            if (binding.llFirst.visibility == View.VISIBLE || binding.llFirst.visibility == View.VISIBLE) {
                if (traumaHistory == "") {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_eep_profile_step_three)
        ctx = this@EEPProfileStepThreeActivity
        activity = this@EEPProfileStepThreeActivity
