...
public interface APINewInterface {
    ...
    @POST("appversion")
    @FormUrlEncoded
    Call<VersionModel> getAppVersions(@Field("Version") String version, @Field("AppType") String appType);

    @POST("loginsignup")
    @FormUrlEncoded
    Call<UserAccessModel> getUserAccess(@Field("MobileNo") String MobileNo, @Field("CountryCode") String CountryCode, @Field("DeviceType") String DeviceType, @Field("SignupFlag") String SignupFlag, @Field("key") String key);

    @POST("authotp")
    @FormUrlEncoded
    Call<AuthOtpModel> getAuthOtpAccess(@Field("OTP") String OTP, @Field("DeviceType") String DeviceType, @Field("DeviceID") String DeviceID, @Field("CountryCode") String CountryCode, @Field("MobileNo") String MobileNo, @Field("SignupFlag") String SignupFlag, @Field("Name") String Name, @Field("Email") String Email, @Field("Token") String Token);
    ...
    @POST("addcouser")
    @FormUrlEncoded
    Call<AddUserModel> getAddUser(@Field("MainAccountID") String MainAccountID, @Field("UserName") String userName, @Field("Email") String email, @Field("MobileNo") String mobileNo);
    ...
    @POST("verifypin")
    @FormUrlEncoded
    Call<AuthOtpModel> getVerifyPin(@Field("UserId") String UserId, @Field("Pin") String pin);
    ...
    @FormUrlEncoded
    Call<AuthOtpModel> getCoUserDetails(@Field("UserId") String UserId);

    @POST("forgotpin")
    @FormUrlEncoded
    Call<SucessModel> getForgotPin(@Field("UserId") String UserId, @Field("Email") String email);

    @POST("profilesaveans")
    @FormUrlEncoded
    Call<ProfileSaveDataModel> getProfileSaveData(@Field("UserId") String UserId, @Field("profileType") String profileType, @Field("gender") String gender, @Field("genderX") String genderX, @Field("age") String age, @Field("prevDrugUse") String prevDrugUse, @Field("Medication") String medication);

    @POST("assesmentsaveans")
    @FormUrlEncoded
    Call<AssessmentSaveDataModel> getAssessmentSaveData(@Field("UserId") String UserId, @Field("ans") String ans);

    @POST("audiodetail")
    @FormUrlEncoded
    Call<AudioDetailModel> getAudioDetail(@Field("UserId") String UserId, @Field("AudioId") String AudioId);

    @POST("createplaylist")
    @FormUrlEncoded
    Call<CreateNewPlaylistModel> getCreatePlaylist(@Field("UserId") String UserId, @Field("PlaylistName") String AudioId);

    @POST("playlistdetails")
    @FormUrlEncoded
    Call<PlaylistDetailsModel> getPlaylistDetail(@Field("UserId") String UserId, @Field("PlaylistId") String PlaylistId);
    ...
    @POST("renameplaylist")
    @FormUrlEncoded
    Call<RenameNewPlaylistModel> getRenameNewPlaylist(@Field("UserId") String UserId, @Field("PlaylistId") String PlaylistId, @Field("PlaylistNewName") String PlaylistNewName);

    @POST("deleteplaylist")
    @FormUrlEncoded
    Call<SucessModel> getDeletePlaylist(@Field("UserId") String userID, @Field("PlaylistId") String playlistId);

    @POST("removeaudiofromplaylist")
    @FormUrlEncoded
    Call<SucessModel> RemoveAudio(@Field("UserId") String UserId, @Field("AudioId") String AudioId, @Field("PlaylistId") String PlaylistId);

    @POST("sortingplaylistaudio")
    @FormUrlEncoded
    Call<SucessModel> SortAudio(@Field("UserId") String UserId, @Field("PlaylistId") String PlaylistId, @Field("PlaylistAudioId") String PlaylistAudioId);
    ...
    @FormUrlEncoded
    Call<AddToPlaylistModel> getAddSearchAudioFromPlaylist(@Field("UserId") String UserId, @Field("AudioId") String audioId, @Field("PlaylistId") String playlistId, @Field("FromPlaylistId") String fromPlaylistId);

    @POST("searchonsuggestedlist")
    @FormUrlEncoded
    Call<SearchBothModel> getSearchBoth(@Field("UserId") String UserId, @Field("SuggestedName") String suggestedName);

    @POST("playlistonviewall")
    @FormUrlEncoded
    Call<ViewAllPlayListModel> getViewAllPlayLists(@Field("UserId") String UserId, @Field("GetLibraryId") String getLibraryId);
    ...
    @FormUrlEncoded
    Call<ViewAllAudioListModel> getViewAllAudioLists(@Field("UserId") String UserId, @Field("GetHomeAudioId") String GetHomeAudioId, @Field("CategoryName") String CategoryName);
    ...
    @FormUrlEncoded
    Call<SaveRecommendedCatModel> getSaveRecommendedCategory(@Field("UserId") String UserId, @Field("CatName") String CatName, @Field("AvgSleepTime") String AvgSleepTime);

    @POST("recentlyplayed")
    @FormUrlEncoded
    Call<SucessModel> getRecentlyPlayed(@Field("UserId") String UserId, @Field("AudioId") String AudioId);
    ...
    @POST("logout")
    @FormUrlEncoded
    Call<SucessModel> getLogout(@Field("UserId") String UserId, @Field("Token") String Token, @Field("DeviceType") String DeviceType);

    @POST("changepin")
    @FormUrlEncoded
    Call<ChangePinModel> getChangePin(@Field("UserId") String UserId, @Field("OldPin") String OldPin, @Field("NewPin") String NewPin);

    @POST("changepassword")
    @FormUrlEncoded
    Call<ChangePinModel> getChangePassword(@Field("MainAccountID") String MainAccountID, @Field("UserId") String UserId, @Field("OldPassword") String OldPassword, @Field("NewPassword") String NewPassword);

    @POST("resourcelist")
    @FormUrlEncoded
    Call<ResourceListModel> getResourceList(@Field("UserId") String UserId, @Field("ResourceTypeId") String ResourceTypeId, @Field("Category") String Category);
    ...
    @POST("setreminder")
    @FormUrlEncoded
    Call<SetReminderOldModel> getSetReminder(@Field("UserId") String UserId, @Field("PlaylistId") String PlaylistId, @Field("ReminderDay") String ReminderDay, @Field("ReminderTime") String ReminderTime, @Field("IsSingle") String IsSingle);
    ...
    @POST("deletereminder")
    @FormUrlEncoded
    Call<DeleteRemiderModel> getDeleteRemider(@Field("UserId") String UserId, @Field("ReminderId") String ReminderId);

    @POST("reminderstatus")
    @FormUrlEncoded
    Call<ReminderStatusModel> getReminderStatus(@Field("UserId") String UserId, @Field("PlaylistId") String PlaylistId, @Field("ReminderStatus") String ReminderStatus);
    ...
    @POST("editprofile")
    @FormUrlEncoded
    Call<EditProfileModel> getEditProfile(@Field("MainAccountID") String MainAccountID, @Field("UserId") String UserId, @Field("Name") String Name, @Field("Dob") String Dob, @Field("MobileNo") String MobileNo, @Field("EmailId") String EmailId);
