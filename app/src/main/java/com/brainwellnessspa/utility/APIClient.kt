...
import com.brainwellnessspa.utility.AppUtils.BASE_URL
...
object APIClient {
    ...
    val client: APIInterface
        @SuppressLint("HardwareIds") get() {
            ...
            retrofit = Retrofit.Builder().baseUrl(BASE_URL).addConverterFactory(GsonConverterFactory.create()).addConverterFactory(ScalarsConverterFactory.create()).client(client).build()
