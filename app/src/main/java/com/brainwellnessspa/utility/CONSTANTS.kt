...
object CONSTANTS {
    ...
    const val PREFE_ACCESS_CardId = "CardId"
    ...
    const val EEPCatName = "EEPCatName"
    const val EEPCatId = "EEPCatId"
    const val AssMain = "AssMain"
    const val AssQus = "AssQus"
    const val AssAns = "AssAns"
    const val AssSort = "AssSort"
    const val ProgressReportMain= "ProgressReportMain"
    const val ProgressReportQus = "ProgressReportQus"
    const val ProgressReportAns = "ProgressReportAns"
