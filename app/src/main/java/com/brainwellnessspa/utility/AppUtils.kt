...
object AppUtils : Application() {
  ...
  /*  private const val STAGING_MAIN_URL = "https://brainwellnessapp.com.au/bwsapi/api/staging/v1/"
    ...
    private const val STAGING_MAIN_URL = "https://brainwellnessapp.com.au/bwsapi/api/staging/v2/"
    private const val LIVE_MAIN_URL = "https://brainwellnessapp.com.au/bwsapi/api/live/v2/"
