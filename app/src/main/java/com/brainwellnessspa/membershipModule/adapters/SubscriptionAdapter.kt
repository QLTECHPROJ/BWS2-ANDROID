...
class SubscriptionAdapter(
    private val listModelList: List<PlanlistInappModel.ResponseData.AudioFile>,
    var ctx: Context
) : RecyclerView.Adapter<SubscriptionAdapter.MyViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val v: SubscribeBoxLayoutBinding = DataBindingUtil.inflate(
            LayoutInflater.from(parent.context), R.layout.subscribe_box_layout, parent, false
        )
    ...
    inner class MyViewHolder(var binding: SubscribeBoxLayoutBinding) : RecyclerView.ViewHolder(
        binding.root
    )
}