...
class MembershipPlanAdapter(
    private val listModelList: ArrayList<MembershipPlanListModel.Plan>,
    var ctx: Context,
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        btnFreeJoin.setOnClickListener {
            if (BWSApplication.isNetworkConnected(
                    ctx
                )
            ) {
    ...
    private fun changeFunction(
        holder: MyViewHolder,
        listModel: MembershipPlanListModel.Plan,
        position: Int
    ) {
