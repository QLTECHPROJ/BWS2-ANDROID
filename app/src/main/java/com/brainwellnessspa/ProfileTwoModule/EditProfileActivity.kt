...
class EditProfileActivity : AppCompatActivity() {
    ...
    var userTextWatcher: TextWatcher = object : TextWatcher {
        ...
        override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
            ...
            if (User.equals(UserName, ignoreCase = true) && Calendar.equals(UserCalendar, ignoreCase = true)
                    && MobileNumber.equals(UserMobileNumber, ignoreCase = true) && Email.equals(UserEmail, ignoreCase = true)) {
    ...
    fun profileUpdate() {
        if (BWSApplication.isNetworkConnected(ctx)) {
            ...
            val listCall = APINewClient.getClient().getEditProfile(CoUserID, binding.etUser.text.toString(), dob,
                    ...
                    try {
                        ...
                        if (viewModel!!.responseCode.equals(getString(R.string.ResponseCodesuccess), ignoreCase = true)) {
                            ...
                            if (viewModel.responseData!!.name.equals("", ignoreCase = true) ||
                                    viewModel.responseData!!.name.equals(" ", ignoreCase = true) || viewModel.responseData!!.name == null) {
