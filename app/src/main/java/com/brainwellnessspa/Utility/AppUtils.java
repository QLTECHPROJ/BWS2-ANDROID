...
public class AppUtils extends Application {
    ...
    public static String tncs_url = Live_MAIN_URL + "/terms-conditions/";
    public static String privacy_policy_url = Live_MAIN_URL + "/privacy-policy/";
    public static String how_refer_works_url = Live_MAIN_URL + "/how-refer-works/";
}