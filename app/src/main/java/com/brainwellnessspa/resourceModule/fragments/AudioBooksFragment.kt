...
class AudioBooksFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        if (bundle != null) {
            audioBooks = bundle.getString("audio_books")
        }
    ...
    fun prepareData() {
        ...
        val listCall = APINewClient.client.getResourceList(userId, CONSTANTS.FLAG_ONE, category)
            ...
            override fun onResponse(call: Call<ResourceListModel?>, response: Response<ResourceListModel?>) {
                try {
                    ...
                    if (listModel!!.responseCode.equals(getString(R.string.ResponseCodesuccess), ignoreCase = true)) {
                        ...
                        val adapter = AudioBooksAdapter(listModel.responseData, activity, audioBooks)
    ...
    inner class AudioBooksAdapter(var listModelList: List<ResourceListModel.ResponseData>?, var ctx: Context?, private var audioBooks: String?) : RecyclerView.Adapter<AudioBooksAdapter.MyViewHolder>() {
        ...
        override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
            val measureRatio = measureRatio(ctx, 0f, 1f, 1f, 0.42f, 0f)
            ...
            holder.binding.rlMainLayout.setOnClickListener {
                ...
                i.putExtra("audio_books", audioBooks)
