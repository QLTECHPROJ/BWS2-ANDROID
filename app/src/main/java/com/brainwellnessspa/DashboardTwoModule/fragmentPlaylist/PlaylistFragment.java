...
public class PlaylistFragment extends Fragment {
    ...
    String CoUserID, Check = "", AudioFlag;
    View view;
...
*/
        if (BWSApplication.isNetworkConnected(getActivity())) {
            BWSApplication.showProgressBar(binding.progressBar, binding.progressBarHolder, getActivity());
            Call<MainPlayListModel> listCall = APINewClient.getClient().getMainPlayLists(CoUserID);
            ...
            binding.rlCreatePlaylist.setOnClickListener(view -> {
                ...
                if (listModelList.get(position).getIsLock().equalsIgnoreCase("1")) {
                    ...
                    btnSendCode.setOnClickListener(view1 -> {
                        if (BWSApplication.isNetworkConnected(getActivity())) {
                            Call<CreatePlaylistModel> listCall = APIClient.getClient().getCreatePlaylist(CoUserID, edtCreate.getText().toString());
