...
data class AuthOtpResponseData(val AreaOfFocus: List<AreaOfFocus>, val AvgSleepTime: String, val DOB: String, val Email: String, val IsFirst: String, val IsInCouser: String, val Image: String, val MainAccountID: String,val CountryCode: String, val Mobile: String, val Name: String, val ScoreLevel: String, val UserId: String, val directLogin: String, val errormsg: String, val indexScore: String, val isAssessmentCompleted: String, val isPinSet: String, val Islock: String, val isProfileCompleted: String, val isMainAccount: String, val CoUserCount: String, val isEmailVerified: String, val planDetails: List<planDetails>)
