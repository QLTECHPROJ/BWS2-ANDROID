...
class IAPCancelMembershipActivity : YouTubeBaseActivity(), YouTubePlayer.OnInitializedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ctx = this@IAPCancelMembershipActivity
        activity = this@IAPCancelMembershipActivity
